...
<!--                   <ul class="list-unstyled">
              ...
              <div class="col-xs-12 bottom text-center">
                <div class="col-xs-12 col-sm-6 col-md-12 emphasis">
                  ...
                  <button type="button" name="sua"  class="btn btn-success btn-xs">
                      <i class="fa fa-repeat"> </i> <a style="color: white" href="sua.php?MaNV=<?php echo $row['MaNV'] ?>">Sửa</a>
                  </button>
                </div>
              </div>
            </div>         
