                  ...
                  if(isset($data) || count($data)){
                      foreach ($data as $key =>$value) {
                          ...
                          echo "<div class='col-sm-2'>
                                <a href='?action=editUser&id=$value[id]'><button class='bt-e'><i class='fa fa-pencil'></i></button></a>
                                <a href='?action=deleteUser&id=$value[id]'><button class='bt-e'><i class='fa fa-trash'></i></button></a>
                              </div>";
                          echo "</div>";
                      }
                  }
