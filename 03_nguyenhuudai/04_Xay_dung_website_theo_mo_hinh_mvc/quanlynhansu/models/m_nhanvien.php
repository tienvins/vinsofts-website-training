<?php
	...
	class M_NhanVien extends database
	{
		...
		function addNhanVien($tennv, $ngaysinh, $quequan, $gioitinh, $sdt, $mapb, $hinh) {
			$sql 		= "Insert into db22_nhanvien (manv, tennv, ngaysinh, quequan, gioitinh, sdt, mapb, hinh) values (null, '$tennv', '$ngaysinh', '$quequan', '$gioitinh', '$sdt', '$mapb', '$hinh')";
			$this->setQuery($sql);
			$this->execute(array($tennv, $ngaysinh, $quequan, $gioitinh, $sdt, $mapb, $hinh));
		}
		...
		function editNhanVien($manv, $tennv, $ngaysinh, $quequan, $gioitinh, $sdt, $mapb, $hinh) {
			...
			$this->setQuery($sql);
			$this->execute(array($manv, $tennv, $ngaysinh, $quequan, $gioitinh, $sdt, $mapb, $hinh));
		}
