...
if (!$ket_qua) {
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate method="post" action="update.php">
 ...
 -->
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="email" name="ngaysinh" required="required" class="form-control col-md-7 col-xs-12" value=" <?php echo $row['ngaysinh'] ?>">
                        </div>
                      </div>
                      <div class="item form-group">
